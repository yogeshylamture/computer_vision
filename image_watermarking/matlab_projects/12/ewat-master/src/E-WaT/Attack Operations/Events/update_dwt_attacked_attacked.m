function update_dwt_attacked_attacked(handles)
        ...
        set(handles.togglebutton_dwt_attacked_attacked,'Enable','off');
        set(handles.togglebutton_dwt_attacked_attacked,'Value',1);
        ...
        switch image_type
            case 'grayscale'
                image_gray = get_root_data('attacked_attacked_dwt_grayscale');
                
                set(handles.label_image_attacked_attacked,'String','DWT');
            ...
            case 'layered'
                switch selected_image
                    case 'ycbcr' 
                        ...
                        set(handles.label_layer_y_attacked_attacked,'String','Y DWT ');
                        set(handles.label_layer_cb_attacked_attacked,'String','Cb DWT ');
                        set(handles.label_layer_cr_attacked_attacked,'String','Cr DWT ');
                         
                        set(handles.label_layer_red_attacked_attacked,'String','Red DWT ');
                        set(handles.label_layer_green_attacked_attacked,'String','Green DWT ');
                        set(handles.label_layer_blue_attacked_attacked,'String','Blue DWT ');
                        ...
                        y = get_root_data('attacked_attacked_dwt_y');
                        cb = get_root_data('attacked_attacked_dwt_cb');
                        cr = get_root_data('attacked_attacked_dwt_cr');
                        
                        red = get_root_data('attacked_attacked_dwt_red');
                        green = get_root_data('attacked_attacked_dwt_green');
                        blue = get_root_data('attacked_attacked_dwt_blue');
                    ...
                    case 'rgb'
                        ...
                        axis off;
                    case 'y'
                        set(handles.label_image_attacked_attacked,'String','Y DWT ');
                        ...
                        axis off;
                    case 'cb'
                        set(handles.label_image_attacked_attacked,'String','Cb DWT ');
                        ...
                        axis off;
                    case 'cr'
                        set(handles.label_image_attacked_attacked,'String','Cr DWT ');
                    ...
                    case 'red'
                        set(handles.label_image_attacked_attacked,'String','Red DWT ');
                        ...
                        axis off;
                    case 'green'
                        set(handles.label_image_attacked_attacked,'String','Green DWT ');
                        ...
                        axis off;
                    case 'blue'
                        set(handles.label_image_attacked_attacked,'String','Blue DWT ');
