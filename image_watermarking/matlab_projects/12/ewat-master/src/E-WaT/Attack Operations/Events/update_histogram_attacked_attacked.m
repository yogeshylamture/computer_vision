function update_histogram_attacked_attacked(handles)

        set(handles.togglebutton_image_attacked_attacked,'Enable','on');
                
        set(handles.togglebutton_histogram_attacked_attacked,'Enable','off');
        set(handles.togglebutton_histogram_attacked_attacked,'Value',1);
        ...
        switch image_type
            case 'grayscale'
                ...
                set(handles.label_image_attacked_attacked,'String','Histogram');
                
                set_root_data(handles,'attacked_attacked_histogram_grayscale', image_gray);
            case 'layered'
                switch selected_image
                    case 'ycbcr'
                         set(handles.label_image_attacked_attacked,'String','YCbCr Histogram ');
                         
                         set(handles.label_icon_ycbcr_attacked_attacked,'String','YCbCr Histogram ');
                         set(handles.label_icon_rgb_attacked_attacked,'String','RGB Histogram ');
                                                  
                         set(handles.label_layer_y_attacked_attacked,'String','Y Histogram ');
                         set(handles.label_layer_cb_attacked_attacked,'String','Cb Histogram ');
                         set(handles.label_layer_cr_attacked_attacked,'String','Cr Histogram ');
                         
                         set(handles.label_layer_red_attacked_attacked,'String','Red Histogram ');
                         set(handles.label_layer_green_attacked_attacked,'String','Green Histogram ');
                         set(handles.label_layer_blue_attacked_attacked,'String','Blue Histogram ');
                         
                         set_root_data(handles,'attacked_attacked_histogram_ycbcr', image_rgb);
                         set_root_data(handles,'attacked_attacked_histogram_icon_ycbcr', image_rgb);
                         set_root_data(handles,'attacked_attacked_histogram_y', image_rgb);
                         set_root_data(handles,'attacked_attacked_histogram_cb', image_rgb);
                         set_root_data(handles,'attacked_attacked_histogram_cr',image_rgb);
                         set_root_data(handles,'attacked_attacked_histogram_icon_rgb', image_rgb);
                         set_root_data(handles,'attacked_attacked_histogram_red', image_rgb);
                         set_root_data(handles,'attacked_attacked_histogram_green', image_rgb);
                         set_root_data(handles,'attacked_attacked_histogram_blue', image_rgb);
                    ...
                    case 'rgb'
                        ...
                        set_root_data(handles,'attacked_attacked_histogram_blue', image_rgb);
                    case 'y'
                        set(handles.label_image_attacked_attacked,'String','Y Histogram ');
                    ...
                    case 'cb'
                        set(handles.label_image_attacked_attacked,'String','Cb Histogram ');
                        ...
                        set_root_data(handles,'attacked_attacked_histogram_blue', image_rgb);
                    case 'cr'
                        set(handles.label_image_attacked_attacked,'String','Cr Histogram ');
                        ...
                        set_root_data(handles,'attacked_attacked_histogram_blue', image_rgb);
                    case 'red'
                        set(handles.label_image_attacked_attacked,'String','Red Histogram ');
                        ...
                        set_root_data(handles,'attacked_attacked_histogram_blue', image_rgb);
                    case 'green'
                        set(handles.label_image_attacked_attacked,'String','Green Histogram ');
                        ...
                        set_root_data(handles,'attacked_attacked_histogram_blue', image_rgb);
                    case 'blue'
                        set(handles.label_image_attacked_attacked,'String','Blue Histogram ');
