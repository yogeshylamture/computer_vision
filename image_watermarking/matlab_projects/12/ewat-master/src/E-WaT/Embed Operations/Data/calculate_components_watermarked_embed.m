function calculate_components_watermarked_embed(handles,im)
%% initialization
type = get_root_data('image_type');
set_root_data(handles,'watermarked_embed',im);
wavelet = 'bior1.1';
...
%% Working Calculations
        ...
        working_image = im(:,:,1);
        set_root_data(handles,'watermarked_embed_working_grayscale',working_image);
        set_root_data(handles,'watermarked_attacked_working_grayscale',working_image);
%% DCT calculations        
        ...
        set_root_data(handles,'watermarked_embed_dct_grayscale',image_dct);
        set_root_data(handles,'watermarked_attacked_dct_grayscale',image_dct);
...
%% DWT Calculations
        ...
        set_root_data(handles,'watermarked_embed_dwt_grayscale',im2uint8(merge));
        set_root_data(handles,'watermarked_attacked_dwt_grayscale',im2uint8(merge));
        
%% Plotting calculations
        set_root_data(handles,'watermarked_embed_plot_grayscale',im);
        set_root_data(handles,'watermarked_attacked_plot_grayscale',im);
...
%% RGB Working
        ...
        set_root_data(handles,'watermarked_embed_working_rgb',im);
        set_root_data(handles,'watermarked_embed_working_red',layer_red);
        set_root_data(handles,'watermarked_embed_working_green',layer_green);
        set_root_data(handles,'watermarked_embed_working_blue',layer_blue);
        
        set_root_data(handles,'watermarked_attacked_working_rgb',im);
        set_root_data(handles,'watermarked_attacked_working_red',layer_red);
        set_root_data(handles,'watermarked_attacked_working_green',layer_green);
        set_root_data(handles,'watermarked_attacked_working_blue',layer_blue);
...
%% RGB DCT
        ...
        set_root_data(handles,'watermarked_embed_dct_red',image_dct_red);
        set_root_data(handles,'watermarked_embed_dct_green',image_dct_green);
        set_root_data(handles,'watermarked_embed_dct_blue',image_dct_blue);
        
        set_root_data(handles,'watermarked_attacked_dct_red',image_dct_red);
        set_root_data(handles,'watermarked_attacked_dct_green',image_dct_green);
        set_root_data(handles,'watermarked_attacked_dct_blue',image_dct_blue);
%% RGB DWT
        figure(current_figure);
        ...
        set_root_data(handles,'watermarked_embed_dwt_red',im2uint8(merge_red));
        set_root_data(handles,'watermarked_embed_dwt_green',im2uint8(merge_green));
        set_root_data(handles,'watermarked_embed_dwt_blue',im2uint8(merge_blue));
        
        set_root_data(handles,'watermarked_attacked_dwt_red',im2uint8(merge_red));
        set_root_data(handles,'watermarked_attacked_dwt_green',im2uint8(merge_green));
        set_root_data(handles,'watermarked_attacked_dwt_blue',im2uint8(merge_blue));
...
%% RGB Plotting
        ...
        set_root_data(handles,'watermarked_embed_plot_rgb',im);
        set_root_data(handles,'watermarked_attacked_plot_rgb',im);
        
        figure(current_figure);
        workbar(54/100,'Calclate variables for plotting the images','Step 4');
        
        set_root_data(handles,'watermarked_embed_plot_red',im_layer1);
        set_root_data(handles,'watermarked_attacked_plot_red',im_layer1);
        
        figure(current_figure);
        workbar(55/100,'Calclate variables for plotting the images','Step 4');
        
        set_root_data(handles,'watermarked_embed_plot_green',im_layer2);
        set_root_data(handles,'watermarked_attacked_plot_green',im_layer2);
        
        figure(current_figure);
        workbar(56/100,'Calclate variables for plotting the images','Step 4');
        
        set_root_data(handles,'watermarked_embed_plot_blue',im_layer3);
        set_root_data(handles,'watermarked_attacked_plot_blue',im_layer3);
...
%% YCbCr Working        
        ...
        set_root_data(handles,'watermarked_embed_working_ycbcr',im_ycbcr);
        set_root_data(handles,'watermarked_embed_working_y',layer_y);
        set_root_data(handles,'watermarked_embed_working_cb',layer_cb);
        set_root_data(handles,'watermarked_embed_working_cr',layer_cr);
        
        set_root_data(handles,'watermarked_attacked_working_ycbcr',im_ycbcr);
        set_root_data(handles,'watermarked_attacked_working_y',layer_y);
        set_root_data(handles,'watermarked_attacked_working_cb',layer_cb);
        set_root_data(handles,'watermarked_attacked_working_cr',layer_cr);
...
%% YCbCr DCT         
        ...
        set_root_data(handles,'watermarked_embed_dct_y',image_dct_y);
        set_root_data(handles,'watermarked_embed_dct_cb',image_dct_cb);
        set_root_data(handles,'watermarked_embed_dct_cr',image_dct_cr);
        
        set_root_data(handles,'watermarked_attacked_dct_y',image_dct_y);
        set_root_data(handles,'watermarked_attacked_dct_cb',image_dct_cb);
        set_root_data(handles,'watermarked_attacked_dct_cr',image_dct_cr);
...
%% YCbCr DWT
        ...
        set_root_data(handles,'watermarked_embed_dwt_y',im2uint8(merge_y));
        set_root_data(handles,'watermarked_embed_dwt_cb',im2uint8(merge_cb));
        set_root_data(handles,'watermarked_embed_dwt_cr',im2uint8(merge_cr));
        
        set_root_data(handles,'watermarked_attacked_dwt_y',im2uint8(merge_y));
        set_root_data(handles,'watermarked_attacked_dwt_cb',im2uint8(merge_cb));
        set_root_data(handles,'watermarked_attacked_dwt_cr',im2uint8(merge_cr));
...
%% YCbCr Plotting 
        ...
        %set_root_data('watermarked_embed_plot_ycbcr',im);
        set_root_data(handles,'watermarked_embed_plot_y',im_layer1);
        set_root_data(handles,'watermarked_embed_plot_cb',im_layer2);
        set_root_data(handles,'watermarked_embed_plot_cr',im_layer3);
        
        set_root_data(handles,'watermarked_attacked_plot_y',im_layer1);
        set_root_data(handles,'watermarked_attacked_plot_cb',im_layer2);
        set_root_data(handles,'watermarked_attacked_plot_cr',im_layer3);
