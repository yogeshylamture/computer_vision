function calculate_components_original(handles,im)
%% initialization
type = get_root_data('image_type');
set_root_data(handles,'original',im);
wavelet = 'bior1.1';
...
%% Working Calculations
        ...
        working_image = im(:,:,1);
        set_root_data(handles,'original_working_grayscale',working_image);
%% DCT calculations        
        ...
        set_root_data(handles,'original_dct_grayscale',image_dct);
...
%% DWT Calculations
        ...
        set_root_data(handles,'original_dwt_grayscale',im2uint8(merge));
        
%% Plotting calculations
        set_root_data(handles,'original_plot_grayscale',im);
...
%% RGB Working
        ...
        set_root_data(handles,'original_working_rgb',im);
        set_root_data(handles,'original_working_red',layer_red);
        set_root_data(handles,'original_working_green',layer_green);
        set_root_data(handles,'original_working_blue',layer_blue);
...
%% RGB DCT
        ...
        set_root_data(handles,'original_dct_red',image_dct_red);
        set_root_data(handles,'original_dct_green',image_dct_green);
        set_root_data(handles,'original_dct_blue',image_dct_blue);
%% RGB DWT
        figure(current_figure);
        ...
        set_root_data(handles,'original_dwt_red',im2uint8(merge_red));
        set_root_data(handles,'original_dwt_green',im2uint8(merge_green));
        set_root_data(handles,'original_dwt_blue',im2uint8(merge_blue));
...
%% RGB Plotting
        ...
        set_root_data(handles,'original_plot_rgb',im);
        
        figure(current_figure);
        workbar(54/100,'Calclate variables for plotting the images','Step 4');
        
        set_root_data(handles,'original_plot_red',im_layer1);
        
        figure(current_figure);
        workbar(55/100,'Calclate variables for plotting the images','Step 4');
        
        set_root_data(handles,'original_plot_green',im_layer2);
        
        figure(current_figure);
        workbar(56/100,'Calclate variables for plotting the images','Step 4');
        
        set_root_data(handles,'original_plot_blue',im_layer3);
...
%% YCbCr Working        
        ...
        set_root_data(handles,'original_working_ycbcr',im_ycbcr);
        set_root_data(handles,'original_working_y',layer_y);
        set_root_data(handles,'original_working_cb',layer_cb);
        set_root_data(handles,'original_working_cr',layer_cr);
...
%% YCbCr DCT         
        ...
        set_root_data(handles,'original_dct_y',image_dct_y);
        set_root_data(handles,'original_dct_cb',image_dct_cb);
        set_root_data(handles,'original_dct_cr',image_dct_cr);
...
%% YCbCr DWT
        ...
        set_root_data(handles,'original_dwt_y',im2uint8(merge_y));
        set_root_data(handles,'original_dwt_cb',im2uint8(merge_cb));
        set_root_data(handles,'original_dwt_cr',im2uint8(merge_cr));
...
%% YCbCr Plotting 
        ...
        %set_root_data('original_plot_ycbcr',im);
        set_root_data(handles,'original_plot_y',im_layer1);
        set_root_data(handles,'original_plot_cb',im_layer2);
        set_root_data(handles,'original_plot_cr',im_layer3);
