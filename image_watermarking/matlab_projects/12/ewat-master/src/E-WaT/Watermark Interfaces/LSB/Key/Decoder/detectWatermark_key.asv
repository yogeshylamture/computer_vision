...
%detectWatermark_key: searches for a watermark and displays the detected
...
function detectWatermark_key(handles, im_wm)
...
[messageType message_im message_t] = searchMessageKey(handles, im_bp_wm(:,:,1));
...
[messageType message_im message_t] = searchMessageKey(handles, im_bp_wm(:,:,2));
...
[messageType message_im message_t] = searchMessageKey(handles, im_bp_wm(:,:,3));
...
[messageType message_im message_t] = searchMessageKey(handles, im_bp_wm(:,:,4));
...
[messageType message_im message_t] = searchMessageKey(handles, im_bp_wm(:,:,5));
...
[messageType message_im message_t] = searchMessageKey(handles, im_bp_wm(:,:,6));
...
[messageType message_im message_t] = searchMessageKey(handles, im_bp_wm(:,:,7));
...
[messageType message_im message_t] = searchMessageKey(handles, im_bp_wm(:,:,8));
