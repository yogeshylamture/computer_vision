...
%%
%change_to_ycbcr_view: changes the entire color represantion to YCbCr
%spectrum
%handles: parameter

function change_to_ycbcr_view(handles)

%% original
                fullcolor = get(handles.togglebutton_fullcolor_original,'Value');
                presentation = get(handles.togglebutton_layers_original,'Value');
                
                set(handles.radiobutton_ycbcr,'Enable','off')
                set(handles.radiobutton_rgb,'Enable','on')
